...
var parent = new Vue({
    ...
    methods:{
        ...
        inputChangeEvent:function(){
            ...
            this.$http.get($('.pageUrls').data('bookinglisturl')+'?page_size='+self.page_size+'&q='+this.search+'&status='+this.status+'&date='+this.date)
                .then(function(data){
        ...
        listItems:function(num){
            this.$http.get($('.pageUrls').data('bookinglisturl')+'?page='+num+'&page_size='+this.page_size+'&status='+this.status+'&date='+this.date)
                .then(function(data){
                    data = JSON.parse(data.bodyText);
                    this.items = data.results;
                    this.loader = false;
